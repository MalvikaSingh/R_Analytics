---
title: "Educational and Disciplinary Outcomes in Pennsylvania"
output: html_document
author: Malvika Singh, Shikha Goel and Elizabeth Speigle
---
...
Testing whether there are significant differences in these indicators by subgroup using ANOVA followed by t-tests. For example, is there a difference in the rates of in-school suspensions by ethnicity?
...
```
Thank you Shikha Goel and Elizabeth Speigle for your contribution to the Project and Domain Knowledge that you've shared and helped in making this Project.
